...
st.set_page_config(
    page_title="Prediksi Harga Copper",
    page_icon="Logo.png",
    layout="wide"
)
...
Prediksi Harga Copper
</div>

<div class="sub-title">
Prediksi harga Copper menggunakan model Deep Learning GRU berbasis data historis Nickel dan Copper.
</div>
""", unsafe_allow_html=True)
